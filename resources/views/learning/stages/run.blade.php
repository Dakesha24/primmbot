...
@section('content')
    ...
    <h1 style="text-align:center;font-size:1.4rem;font-weight:800;color:#fff;margin-bottom:1.5rem;letter-spacing:-0.3px;">RUN
    </h1>
    ...
    <div class="run-layout">
        ...
        <div class="run-left">
            ...
            <div class="editor-card">
                ...
                <textarea id="sql-editor" class="editor-textarea" placeholder="Tulis query SQL di sini...">{{ $submission->answer_code ?? ($activity->code_snippet ?? '') }}</textarea>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (btnCek) {
                btnCek.addEventListener('click', async function() {
                    ...
                    const code = sqlEditor ? sqlEditor.value.trim() : '';
                    if (!text && !code) {
            ...
            function showFB(msg, color) {
                ...
                if (!box) {
                    ...
                    box.id = 'feedback-box';
                    btnCek.closest('div[style*="border-top"]').appendChild(box);
                }
                const c = {
