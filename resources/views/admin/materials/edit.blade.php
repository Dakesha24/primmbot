<x-layouts.admin title="Edit Materi">
    <x-slot:styles>
    ...
    <div class="form-card">
        <h2>Edit Materi — {{ ucwords(str_replace('_', ' ', $material->type)) }}</h2>
        ...
        <form method="POST" action="{{ route('admin.materials.update', [$course, $chapter, $material]) }}"
            id="materialForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="type" required>
                        <option value="pendahuluan"
                            {{ old('type', $material->type) == 'pendahuluan' ? 'selected' : '' }}>Pendahuluan</option>
                        <option value="petunjuk_belajar"
                            {{ old('type', $material->type) == 'petunjuk_belajar' ? 'selected' : '' }}>Petunjuk Belajar
                        </option>
                        <option value="tujuan" {{ old('type', $material->type) == 'tujuan' ? 'selected' : '' }}>Tujuan
                            Pembelajaran</option>
                        <option value="prasyarat" {{ old('type', $material->type) == 'prasyarat' ? 'selected' : '' }}>
                            Prasyarat Tools</option>
                        <option value="ringkasan_materi"
            ...
            <div class="form-group">
                <label>Konten *</label>
                <div id="editor-container">{!! old('content', $material->content) !!}</div>
