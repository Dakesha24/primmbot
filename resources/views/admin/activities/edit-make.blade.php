<x-layouts.admin title="Edit Aktivitas — Make">
    <x-slot:styles>
        ...
        <style>
            ...
            .expected-output-preview { border: 1px solid #d1fae5; border-radius: 5px; overflow: hidden; margin-top: 10px; }
            .preview-header { display: flex; align-items: center; gap: 6px; padding: 8px 14px; background: #f0fdf4; color: #16a34a; font-size: 12px; font-weight: 600; border-bottom: 1px solid #d1fae5; }
            ...
            <div class="form-panel">
                ...
                <div class="form-group">
                    ...
                    <textarea name="question_text" rows="2" required
                        placeholder="Contoh: Buat query untuk menampilkan nama pelanggan beserta judul buku yang pernah dibeli, diurutkan berdasarkan nama pelanggan.">{{ old('question_text', $activity->question_text) }}</textarea>
                ...
                <div class="field-hint" style="margin-bottom:12px;">SQL jawaban yang benar. Klik <strong>Jalankan & Simpan ▶</strong> untuk memperbarui expected output.</div>
                <div class="admin-editor-wrap">
                    ...
                    <textarea name="reference_sql" id="sqlRef" class="admin-editor-code" rows="6"
                        placeholder="SELECT p.nama_pelanggan, b.judul&#10;FROM pelanggan p&#10;JOIN transaksi t ON p.id_pelanggan = t.id_pelanggan&#10;JOIN buku b ON t.id_buku = b.id_buku&#10;ORDER BY p.nama_pelanggan;">{{ old('reference_sql', $activity->reference_sql) }}</textarea>
                    <div id="ref-result-wrap-js"></div>
                </div>
