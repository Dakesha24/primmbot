<x-layouts.admin title="Tambah Aktivitas — Predict">
    <x-slot:styles>
        ...
        <style>
            ...
            .db-panel-head .panel-title {
                font-size: 12px; font-weight: 700;
                color: #0f1b3d; text-transform: uppercase; letter-spacing: 0.05em;
            }
            ...
            .db-selector select {
                ...
                border: 1.5px solid #dde1ea; border-radius: 5px;
                font-size: 12.5px; font-family: inherit; color: #1a2332; background: #fff;
            ...
            .db-new-link {
                ...
                font-size: 11px; font-weight: 700;
                color: #3b5bdb; background: #eef2ff; text-decoration: none; white-space: nowrap;
            }
            ...
            /* Table accordion */
            .db-table-item {
                border: 1px solid #e4e8f1; border-radius: 5px; margin-bottom: 8px; overflow: hidden;
            }

            .db-table-head {
                display: flex; align-items: center; justify-content: space-between;
                padding: 8px 12px; cursor: pointer; background: #f8f9fc;
            ...
            .db-table-head .tname code {
                font-size: 10px; background: #eef2ff; color: #3b5bdb;
                padding: 1px 5px; border-radius: 3px; margin-left: 6px; font-weight: 400;
            }
            .db-table-head .tcount {
                font-size: 10px; color: #6b7a99; background: #f0f2f7;
                padding: 2px 7px; border-radius: 10px; flex-shrink: 0;
            }
            .db-table-head .chevron {
                font-size: 10px; color: #94a3b8; margin-left: 8px; transition: transform 0.15s;
            }

            .db-table-body { display: none; padding: 10px 12px; border-top: 1px solid #e4e8f1; }
            .db-table-body.open { display: block; }
            .db-table-body.open ~ .db-table-head .chevron { transform: rotate(180deg); }
            ...
            .col-chip {
                ...
                border-radius: 3px; border: 1px solid #e4e8f1;
                background: #fafafa; color: #1a2332; font-weight: 500;
            }
            ...
            .mini-table th {
                background: #f0f2f7; padding: 5px 8px; text-align: left;
                font-weight: 700; color: #4a5568; white-space: nowrap;
                border-bottom: 1px solid #e4e8f1;
            }
            .mini-table td {
                padding: 4px 8px; border-bottom: 1px solid #f0f2f7;
                color: #1a2332; max-width: 120px;
            ...
            .erd-label {
                font-size: 10px; font-weight: 700; color: #6b7a99;
                text-transform: uppercase; letter-spacing: 0.06em;
            }
            .erd-fullscreen-btn {
                font-size: 11px; font-weight: 700; color: #3b5bdb;
                background: #eef2ff; border: none; padding: 3px 8px;
            ...
            .form-panel {
                ...
                border-radius: 6px; box-shadow: 3px 3px 0 #c8cfdc;
                padding: 28px 32px;
            }

            .section-title {
                font-size: 13px; font-weight: 700; color: #0f1b3d; margin-bottom: 3px;
            }
            .field-hint { font-size: 11px; color: #94a3b8; }

            .section-divider {
                border: none; border-top: 1px dashed #e4e8f1; margin: 22px 0;
            }
            ...
            /* Admin editor wrap */
            .admin-editor-wrap {
                border: 1px solid #e4e8f1; border-radius: 6px;
            ...
            .admin-btn-run {
                ...
                padding: 5px 14px; background: #3b5bdb; color: #fff;
                border: none; border-radius: 4px; font-size: 11.5px; font-weight: 700;
                font-family: inherit; cursor: pointer; transition: background 0.15s;
            }
            .admin-btn-run:hover { background: #2f4cc0; }
            .admin-btn-run:disabled { opacity: 0.6; cursor: not-allowed; }

            textarea.admin-editor-code {
                font-family: 'Courier New', monospace; font-size: 13px; line-height: 1.7;
                background: #f0f4f8; color: #0f1b3d;
                border: none; padding: 12px 14px;
                width: 100%; min-height: 140px; resize: vertical;
                display: block; box-sizing: border-box; font-weight: 500;
            }
            ...
            /* SQL Results */
            .sql-result-box {
                border-top: 1px solid #e4e8f1; overflow: hidden;
            }

            .sql-result-header {
                display: flex; align-items: center; gap: 7px;
                padding: 8px 14px; font-size: 12px; font-weight: 600; border-bottom: 1px solid #e4e8f1;
            }
            ...
            .result-table th {
                background: #f0f2f7; padding: 7px 12px;
            ...
            .sql-error-msg {
                padding: 14px; font-size: 12px; color: #991b1b;
                font-family: 'Courier New', monospace; background: #fef2f2; line-height: 1.6;
            }
            ...
            .erd-modal-box {
                background: #fff; border-radius: 8px; border: 1px solid #e4e8f1;
                padding: 24px; max-width: 800px; width: 92%; max-height: 88vh;
                overflow: auto; box-shadow: 0 20px 48px rgba(10,18,40,0.18); position: relative;
            }
            .erd-modal-head {
            ...
            .erd-close {
                width: 30px; height: 30px; border-radius: 5px; border: 1px solid #e4e8f1;
            ...
            .form-errors {
                ...
                font-size: 12.5px; margin-bottom: 20px; line-height: 1.7;
            }
        </style>
    </x-slot:styles>
        ...
        <div class="predict-grid">
            ...
            <div class="db-panel">
                <div class="db-panel-head">
                    ...
                    <span class="stage-pill">PREDICT</span>
                </div>
                <div class="db-panel-inner">
                    ...
                    <div class="db-hint">Pilih database yang digunakan siswa saat mengerjakan soal ini.</div>
            ...
            <div class="form-panel">
                ...
                {{-- Deskripsi Soal --}}
                <div class="section-title">Deskripsi Soal</div>
                <div class="field-hint" style="margin-bottom:12px;">Cerita konteks, tabel data, atau gambar yang ditampilkan ke siswa sebelum pertanyaan.</div>
                ...
                <div class="form-group">
                    <label>Pertanyaan Prediksi *</label>
                    <textarea name="question_text" rows="3" required
                        placeholder="Contoh: Apa output yang dihasilkan dari query di atas? Tuliskan prediksimu.">{{ old('question_text') }}</textarea>
                    <div class="field-hint" style="margin-top:5px;">Pertanyaan yang meminta siswa memprediksi hasil query SQL sebelum dijalankan.</div>
                </div>
                ...
                <div class="field-hint" style="margin-bottom:12px;">Query SQL yang ditampilkan ke siswa (read-only). Klik <strong>Jalankan ▶</strong> untuk melihat preview output-nya.</div>
                ...
                <div class="admin-editor-wrap">
                    ...
                    <textarea name="code_snippet" id="sqlInput" class="admin-editor-code" rows="6"
                        placeholder="SELECT p.nama_penerbit, b.judul_buku&#10;FROM penerbit p&#10;JOIN buku b ON p.id_penerbit = b.id_penerbit&#10;ORDER BY p.nama_penerbit;">{{ old('code_snippet') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="reference_answer" rows="5"
                        ...
                        placeholder="Tulis contoh jawaban yang menunjukkan kualitas reasoning yang diharapkan. AI menggunakan ini sebagai acuan penilaian — bukan untuk mencocokkan kata per kata.">{{ old('reference_answer') }}</textarea>
    ...
    <x-slot:scripts>
        ...
        <script>
            ...
            function renderDbPanel(tables) {
                ...
                tables.forEach((t, i) => {
                    ...
                    if (t.columns.length > 0) {
                        ...
                        if (t.total > 10) {
                            html += `<div style="font-size:10px;color:#94a3b8;margin-top:6px;">${t.total} baris total — menampilkan 10 pertama</div>`;
                        }
                    }
            ...
            async function runSql() {
                ...
                try {
                    ...
                    if (data.success && data.type === 'select') {
                        let html = `<div class="sql-result-box">
                            <div class="sql-result-header success">
                                ...
                                ${data.row_count} baris ditemukan
                            </div>
                        ...
                        if (data.columns.length > 0) {
                            ...
                            data.rows.forEach(row => {
                                ...
                                data.columns.forEach(c => {
                                    const v = row[c] !== null && row[c] !== undefined ? escHtml(String(row[c])) : '<em style="color:#94a3b8">NULL</em>';
                                    html += `<td>${v}</td>`;
                                });
                                html += '</tr>';
                            });
                        ...
                        resultWrap.innerHTML = `<div class="sql-result-box">
                            <div class="sql-result-header info">
                                <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                                ${escHtml(data.message ?? 'Berhasil dijalankan')}
                            </div>
                        </div>`;
                    } else {
                        resultWrap.innerHTML = `<div class="sql-result-box">
                            <div class="sql-result-header error">
                            ...
                            <div class="sql-error-msg">${escHtml(data.error)}</div>
                        </div>`;
                    }
                } catch (e) {
                    resultWrap.innerHTML = `<div class="sql-result-box">
                        <div class="sql-result-header error">Koneksi gagal</div>
                        <div class="sql-error-msg">Tidak dapat terhubung ke server.</div>
                    </div>`;
                } finally {
                    btn.disabled = false;
                    btn.innerHTML = `<svg width="11" height="11" fill="currentColor" viewBox="0 0 24 24"><polygon points="5,3 19,12 5,21"/></svg> Jalankan`;
                }
            }
            ...
            // Auto-load if DB already selected (e.g. after validation error)
