<x-layouts.admin title="Edit Aktivitas — Run">
    <x-slot:styles>
        <style>
            ...
            .run-grid { display: grid; grid-template-columns: 360px 1fr; gap: 24px; align-items: start; }
            ...
            .stage-pill { font-size: 11px; font-weight: 700; padding: 3px 10px; border-radius: 4px; background: #d1fae5; color: #065f46; }
            ...
            <div class="form-panel">
                ...
                <div class="form-group">
                    ...
                    <textarea name="question_text" rows="3" required
                        placeholder="Contoh: Apa yang terjadi ketika query ini dijalankan? Jelaskan hasilnya.">{{ old('question_text', $activity->question_text) }}</textarea>
