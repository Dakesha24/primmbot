<x-layouts.admin title="Tambah Aktivitas — Run">
    <x-slot:styles>
        <style>
            .breadcrumb {
    ...
    <div class="breadcrumb">
        ...
        <span>›</span>
        <span>Tambah Aktivitas — Run</span>
    </div>
        ...
        <div class="run-grid">
            ...
            <div class="db-panel">
                <div class="db-panel-head">
                    ...
                    <span class="stage-pill">RUN</span>
                </div>
                <div class="db-panel-inner">
                    ...
                    <div class="db-hint">Database wajib dipilih untuk tahap Run.</div>
            ...
            <div class="form-panel">
                ...
                {{-- Kode SQL --}}
                <div class="section-title">Kode SQL Awal</div>
                <div class="field-hint" style="margin-bottom:12px;">Query SQL yang diberikan ke siswa. Siswa dapat mengedit dan menjalankan query ini. Klik <strong>Jalankan ▶</strong> untuk preview.</div>
                ...
                <div class="admin-editor-wrap">
                    ...
                    <textarea name="code_snippet" id="sqlInput" class="admin-editor-code" rows="6"
                        placeholder="SELECT *&#10;FROM products&#10;JOIN categories ON products.category_id = categories.id;">{{ old('code_snippet') }}</textarea>
                ...
                <div class="form-group">
                    <label>Pertanyaan Refleksi *</label>
                    <textarea name="question_text" rows="3" required
                        placeholder="Contoh: Apa yang terjadi ketika query ini dijalankan? Jelaskan hasilnya.">{{ old('question_text') }}</textarea>
                    <div class="field-hint" style="margin-top:5px;">Pertanyaan refleksi setelah siswa menjalankan query SQL.</div>
                </div>
