<x-layouts.admin title="Tambah Aktivitas — Investigate">
    <x-slot:styles>
        <style>
    ...
    <div class="breadcrumb">
        ...
        <span>›</span>
        <span>Tambah Aktivitas — Investigate</span>
    </div>
    ...
    <form method="POST" action="{{ route('admin.activities.store', [$course, $chapter]) }}" id="activityForm">
        ...
        <div class="inv-grid">
            ...
            <div class="form-panel">
                ...
                {{-- Level --}}
                @php $currentLevel = old('level', $level ?? ''); @endphp
                ...
                <div class="form-group">
                    ...
                    <textarea name="question_text" rows="3" required
                        placeholder="Contoh: Apa fungsi dari klausa JOIN pada query di atas?">{{ old('question_text') }}</textarea>
