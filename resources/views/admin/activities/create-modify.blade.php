<x-layouts.admin title="Tambah Aktivitas — Modify">
    <x-slot:styles>
    ...
    <div class="breadcrumb">
        ...
        <span>›</span>
        <span>Tambah Aktivitas — Modify</span>
    </div>
    ...
    <form method="POST" action="{{ route('admin.activities.store', [$course, $chapter]) }}" id="activityForm">
        ...
        <div class="mod-grid">
            ...
            <div class="form-panel">
                ...
                {{-- Level Info --}}
                @php $modifyCount = $chapter->activities()->where('stage', 'modify')->count(); @endphp
                ...
                <div class="form-group">
                    ...
                    <textarea name="question_text" rows="2" required
                        placeholder="Contoh: Modifikasi query berikut agar menampilkan hanya buku dengan harga di atas 50.000.">{{ old('question_text') }}</textarea>
                ...
                <div class="admin-editor-wrap">
                    ...
                    <textarea name="editor_default_code" id="sqlInput" class="admin-editor-code" rows="6"
                        placeholder="SELECT *&#10;FROM buku&#10;JOIN penerbit ON buku.id_penerbit = penerbit.id_penerbit;">{{ old('editor_default_code') }}</textarea>
                ...
                <div class="field-hint" style="margin-bottom:12px;">SQL yang sudah dimodifikasi dengan benar. Klik <strong>Jalankan & Simpan ▶</strong> untuk menyimpan output sebagai acuan penilaian AI.</div>
                <div class="admin-editor-wrap">
                    <div class="admin-editor-bar">
        ...
        <script>
            ...
            async function runRefSql() {
                ...
                try {
                    ...
                    const data = await res.json();
                    if (data.success && data.type === 'select') {
                        // Simpan sebagai JSON expected_output
            ...
            // Tampilkan badge jika sudah ada expected_output (dari old())
