<x-layouts.admin title="Edit Aktivitas — Predict">
    <x-slot:styles>
        ...
        <style>
            ...
            .db-panel-head {
                padding: 14px 18px 12px; border-bottom: 1px solid #e4e8f1;
                display: flex; align-items: center; justify-content: space-between;
                position: sticky; top: 0; background: #fff; z-index: 2;
            }
            .db-panel-head .panel-title {
                font-size: 12px; font-weight: 700; color: #0f1b3d;
                text-transform: uppercase; letter-spacing: 0.05em;
            }
            .stage-pill { font-size: 11px; font-weight: 700; padding: 3px 10px; border-radius: 4px; background: #fef3c7; color: #92400e; }
            .db-panel-inner { padding: 16px 18px; }
            .db-selector { display: flex; gap: 8px; align-items: center; margin-bottom: 4px; }
            .db-selector select {
                flex: 1; padding: 8px 10px; border: 1.5px solid #dde1ea; border-radius: 5px;
                font-size: 12.5px; font-family: inherit; color: #1a2332; background: #fff; transition: border-color 0.15s;
            }
            ...
            #desc-editor { height: 220px; background: #fff; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13.5px; }
            ...
            .erd-modal-box { background: #fff; border-radius: 8px; border: 1px solid #e4e8f1; padding: 24px; max-width: 800px; width: 92%; max-height: 88vh; overflow: auto; box-shadow: 0 20px 48px rgba(10,18,40,0.18); }
    ...
    <div class="breadcrumb">
        ...
        <span>›</span>
        <span>Edit Aktivitas — Predict</span>
    </div>
            ...
            <div class="form-panel">
                ...
                <div class="form-group">
                    ...
                    <textarea name="question_text" rows="3" required
                        placeholder="Contoh: Apa output yang dihasilkan dari query di atas?">{{ old('question_text', $activity->question_text) }}</textarea>
                ...
                <div class="admin-editor-wrap">
                    ...
                    <textarea name="code_snippet" id="sqlInput" class="admin-editor-code" rows="6"
                        placeholder="SELECT ...">{{ old('code_snippet', $activity->code_snippet) }}</textarea>
    ...
    <x-slot:scripts>
        ...
        <script>
            ...
            // Auto-load schema if DB already selected
