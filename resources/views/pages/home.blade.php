...
<body>
        ...
        <div class="nav-links">
            ...
            @auth
                <a href="{{ route('dashboard') }}" class="btn btn-primary"
                    style="padding: 0.5rem 1.2rem; font-size: 0.8rem;">Dashboard</a>
            @else
                <a href="{{ route('login') }}">Masuk</a>
                <a href="{{ route('register') }}" class="btn btn-primary"
                    style="padding: 0.5rem 1.2rem; font-size: 0.8rem;">Daftar</a>
            @endauth
        </div>
    </nav>
    ...
    <section class="hero">
        <div class="hero-text">
            ...
            <p class="fade-up fade-up-d2">
                Asah kemampuan logical thinking kamu di materi Basis Data lewat model pembelajaran PRIMM, ditemani
                Virtual Assistant yang siap membantu kapan saja!
            </p>
            <div class="hero-buttons fade-up fade-up-d3">
                <a href="{{ route('login') }}" class="btn btn-primary">Mulai Belajar</a>
                <a href="#features" class="btn btn-outline">Pelajari Lebih</a>
            </div>
        </div>
        <div class="timpa-tinggi">
    ...
    <section class="features" id="features">
        <div class="feature-card fade-up fade-up-d1">
            ...
            <h3>Model PRIMM</h3>
            <p>Belajar bertahap melalui Predict, Run, Investigate, Modify, dan Make untuk membangun pemahaman SQL yang
                mendalam.</p>
        </div>
        <div class="feature-card fade-up fade-up-d2">
            <div class="feature-icon fi-cyan">🤖</div>
            <h3>AI Virtual Assistant</h3>
            <p>Asisten virtual cerdas yang membimbing tanpa memberikan jawaban langsung — mendorongmu berpikir kritis
                dan mandiri.</p>
        </div>
        <div class="feature-card fade-up fade-up-d3">
            <div class="feature-icon fi-purple">⚡</div>
            <h3>SQL Editor Interaktif</h3>
            <p>Tulis dan jalankan query SQL secara langsung di browser. Lihat hasilnya real-time dan dapatkan feedback
                instan.</p>
        </div>
    </section>
